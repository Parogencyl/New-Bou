...
<head>
    ...
    <link href="{{ asset('public/css/obsluga/contact.css')}}" rel="stylesheet">
...
<body>
    ...
    <section>
        <div>
            ...
            <form method="POST" action="{{url('/email/wyslij')}}" id="questionFrom">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="Podaj swój adres email" id="email" name="email" required>
                    ...
                    <button type="submit" class="btn btn-danger" id="log"> Wyślij </button>
                </form>
            </div>
